...
function heisenberg_scripts() {
	...
	if ( WP_DEBUG ) {
		wp_enqueue_script ( 'app-js', get_template_directory_uri() . '/assets/dist/js/app.js', array( 'jquery' ), '1.0', true );
	} else {
		wp_enqueue_script ( 'app-min-js', get_template_directory_uri() . '/assets/dist/js/app.min.js', array( 'jquery' ), '1.0', true );
	}
}
